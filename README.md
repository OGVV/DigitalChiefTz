...
1.Изменить настройки подключения в базе данных(url,login,passsword)
2.Импортировать backup базы данных 
3.Импортировать запросы в postman
4.
